<nav class="navbar navbar-expand-sm navbar-dark fixed-bottom" style="background-color: #FF7A00">
    ...
    <div class="row my-2 mx-auto">
        ...
        <div class="mx-4" style="height: 60px; width: 60px; background-color: #FF7A00; border-radius: 10px;">
            ...
            <a href="/beranda"><image src="{{asset('images/Group 1.png')}}" style="height: 40px"/></a> 
        </div>
        ...
        <div class="mx-4" style="height: 60px; width: 60px; background-color: #FF7A00; border-radius: 10px">
            ...
            <a href="/riwayat"><image class="" src="{{asset('images/Group 2.png')}}" style="height: 40px"/></a>
        </div>
        ...
        <div class="mx-4" style="height: 60px; width: 60px; background-color: #FF7A00; border-radius: 10px">
            ...
            <a  href="/akun"><img src="images/Group 3.png" style="height: 40px"/></a>
        </div>
    </div>
</nav>